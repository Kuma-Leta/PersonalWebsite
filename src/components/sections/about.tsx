...
const About: React.FC = () => {
  ...
  return (
    <section
      ...
      id="about"
    >
      <div className="container mx-auto px-6 lg:px-12 font-sans flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="lg:w-1/2" data-aos="slide-right">
          ...
          <p className="mt-4 text-lg text-gray-700 font-serif text-justify dark:text-gray-300">
