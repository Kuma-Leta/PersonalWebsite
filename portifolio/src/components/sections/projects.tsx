...
const projects = [
  ...
  },
  {
    ...
    description:
      "A fully functional social media platform with user profiles, posts, likes, and comments.",
    images: [
  ...
  },
  {
    ...
    description:
      "A fully functional web based brokerage system  with features such as property posting ,registering ,admin dashboard",
    images: [
      "brokerage_home.jpg",
      "brokerage_login.jpg",
...
const Projects: React.FC = () => {
  ...
  return (
    <section className="bg-gray-100 dark:bg-gray-900 py-16" id="projects">
